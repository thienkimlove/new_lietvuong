                ...
                <div class="box-uses cf">
                    ...
                    <div class="news-home cf active" id="tab-index">
                        @if ($getIndexTopCategoryPosts = \App\Site::getIndexCategoryPosts($topIndexCategory, 3))
                            ...
                            @foreach ($getIndexTopCategoryPosts as $getIndexTopCategoryPost)
                                <article class="item">
                                    <a href="{{url($getIndexTopCategoryPost->slug.'.html')}}" title="{{$getIndexTopCategoryPost->title}}" class="thumbs" style="background-image: url({{url('files/images', $getIndexTopCategoryPost->image)}})">
                                        <img src="{{url('files/images', $getIndexTopCategoryPost->image)}}" alt="" class="imgFull">
                                    </a>
                                    <h3>
                    ...
                    @foreach ($topIndexCategory->subCategories as $subTop)
                        <div class="news-home cf" id="{{$firstTabs[$loop->index]}}">
                            @if ($getIndexTopCategoryPosts = \App\Site::getIndexCategoryPosts($subTop, 3))
                                @foreach ($getIndexTopCategoryPosts as $getIndexTopCategoryPost)
                                    <article class="item">
                                        <a href="{{url($getIndexTopCategoryPost->slug.'.html')}}" title="{{$getIndexTopCategoryPost->title}}" class="thumbs" style="background-image: url({{url('files/images', $getIndexTopCategoryPost->image)}})">
                                        ...
                                        <p>
                                            {{str_limit($getIndexTopCategoryPost->desc, 55)}}
                                        </p>
                ...
                <div class="block-news">
                    ...
                    <div class="listNews cf">
                        @foreach ($getIndexThirdCategoryPosts as $getIndexThirdCategoryPost)
                            <div class="item">
                            <a href="{{url($getIndexThirdCategoryPost->slug.'.html')}}" class="thumbs" style="background-image: url({{url('files/images', $getIndexThirdCategoryPost->image)}})">
                                <img src="{{url('files/images', $getIndexThirdCategoryPost->image)}}" alt="{{$getIndexThirdCategoryPost->title}}">
                            </a>
                            <h3>
