...
<head>
    ...
    <meta property="fb:app_id" content="482537005609134"/>
    <title>{{!empty($meta_title)? $meta_title : 'Tuyến tiền liệt - Chuyên trang cộng đồng về bệnh phì đại tiền liệt tuyến'}}</title>
    ...
    <meta name="google-site-verification" content="gsTMVOkTd2K-uSE5UMByRJgizki8W12tiH_PB98LMys" />
    <meta name="apple-mobile-web-app-capable" content="yes"/>
    <meta name="apple-mobile-web-app-status-bar-style" content="black"/>
    <meta name="description" content="{{!empty($meta_desc)? $meta_desc : 'Tuyến tiền liệt - Chuyên trang cộng đồng về bệnh phì đại tiền liệt tuyến'}}"/>
    <meta name="keyword" content="{{!empty($meta_keywords)? $meta_keywords : 'tiểu đêm, tiểu khó, tiền liệt tuyến, u xơ tiền liệt tuyến, tiểu buốt, tiền liệt vương, tuyến tiền liệt'}}"/>
...
<div class="fb-customerchat"
  ...
  page_id="901499823258621"
  logged_in_greeting="Chào bạn, bạn cần hỗ trợ ?"
  logged_out_greeting="Chào bạn, bạn cần hỗ trợ ?">
</div>

<script>
    window.fbAsyncInit = function() {
        FB.init({
            appId      : '482537005609134',
            xfbml      : true,
            version    : 'v3.2'
        });
